...
def main():
    ...
    parser.add_argument(
        ...
        help=".pcd file path.",
        type=str,
        default="../../dataset/kitti/demo/2011_09_26_drive_0014_sync/2011_09_26/2011_09_26_drive_0014_sync/LiDAR2"
    )
    parser.add_argument(
        "--bin_path",
        help=".bin file path.",
        type=str,
        default="../../dataset/kitti/demo/2011_09_26_drive_0014_sync/2011_09_26/2011_09_26_drive_0014_sync/bin2"
    )
    parser.add_argument(
        "--file_name",
        help="File name.",
    ...
    for (path, dir, files) in os.walk(args.pcd_path):
        for filename in files:
            ...
            if ext == '.pcd':
                ...
                pcd_file_names.append(filename[:-4])

    ## Sort pcd files by file name
    pcd_files.sort()
    print("Finish to load point clouds!", len(pcd_files))
    ...
    for pcd_file in tqdm(pcd_files):
        ...
        bin_file_name = "{}.bin".format(pcd_file_names[seq])
